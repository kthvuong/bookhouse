/* ============================================================
   ...
   One key in Vercel KV holds the latest full library snapshot from
   js/storage.js's Storage.exportAll() (minus covers, which stay
   device-local). GET returns it, POST overwrites it. This is
   whole-snapshot, last-write-wins sync for a single user — not a
...
module.exports = async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    ...
    await kv.set(SNAPSHOT_KEY, { data: body, updatedAt });
